...
HD_PWD='C:/Users/lsneler/Desktop/Repository/DCT/DCT/DCT.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log DCT.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source DCT.tcl -notrace
