...
CONFIG.NUM_MI {1} \
  ...
  connect_bd_net -net AXILiteToBRAMIntf_0_BRAMAddress [get_bd_pins AXILiteToBRAMIntf_0/BRAMAddress] [get_bd_pins blk_mem_gen_0/addra]
  connect_bd_net -net AXILiteToBRAMIntf_0_BRAMDataOut [get_bd_pins AXILiteToBRAMIntf_0/BRAMDataOut] [get_bd_pins blk_mem_gen_0/dina]
  connect_bd_net -net AXILiteToBRAMIntf_0_BRAMWea [get_bd_pins AXILiteToBRAMIntf_0/BRAMWea] [get_bd_pins blk_mem_gen_0/wea]
  connect_bd_net -net blk_mem_gen_0_douta [get_bd_pins AXILiteToBRAMIntf_0/BRAMDataIn] [get_bd_pins blk_mem_gen_0/douta]
  ...
  connect_bd_net -net rst_ps7_0_50M_peripheral_aresetn [get_bd_pins AXILiteToBRAMIntf_0/s00_axi_aresetn] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps7_0_50M/peripheral_aresetn]
