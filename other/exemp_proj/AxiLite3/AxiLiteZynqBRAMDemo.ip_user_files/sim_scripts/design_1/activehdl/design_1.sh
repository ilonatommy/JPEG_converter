...
copy_setup_file()
{
  ...
  if [[ ($1 != "") ]]; then
    ...
    lib_map_path="C:/Users/lsneler/Desktop/Repository/JPEG_conversion/exemplary_projects/AxiLiteZynqBRAMDemo3/AxiLiteZynqBRAMDemo/AxiLiteZynqBRAMDemo.cache/compile_simlib/activehdl"
  fi
