...
set rc [catch {
  ...
  add_files -quiet C:/Users/lsneler/Desktop/Repo/JPEG_conv/quantizator/quantizator.runs/synth_1/quant.dcp
  ...
  link_design -top quant -part xc7z010clg400-1
...
set rc [catch {
  ...
  opt_design 
  write_checkpoint -force quant_opt.dcp
  catch { report_drc -file quant_drc_opted.rpt }
...
set rc [catch {
  ...
  place_design 
  write_checkpoint -force quant_placed.dcp
  catch { report_io -file quant_io_placed.rpt }
  catch { report_utilization -file quant_utilization_placed.rpt -pb quant_utilization_placed.pb }
  catch { report_control_sets -verbose -file quant_control_sets_placed.rpt }
...
set rc [catch {
  ...
  route_design 
  write_checkpoint -force quant_routed.dcp
  catch { report_drc -file quant_drc_routed.rpt -pb quant_drc_routed.pb -rpx quant_drc_routed.rpx }
  catch { report_methodology -file quant_methodology_drc_routed.rpt -rpx quant_methodology_drc_routed.rpx }
  catch { report_power -file quant_power_routed.rpt -pb quant_power_summary_routed.pb -rpx quant_power_routed.rpx }
  catch { report_route_status -file quant_route_status.rpt -pb quant_route_status.pb }
  catch { report_clock_utilization -file quant_clock_utilization_routed.rpt }
  catch { report_timing_summary -warn_on_violation -max_paths 10 -file quant_timing_summary_routed.rpt -rpx quant_timing_summary_routed.rpx }
  close_msg_db -file route_design.pb
} RESULT]
if {$rc} {
  write_checkpoint -force quant_routed_error.dcp
