...
HD_PWD='C:/Users/lsneler/Desktop/Repo/JPEG_conv/quantizator/quantizator.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log quant.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source quant.tcl -notrace
