...
HD_PWD='C:/Users/lsneler/Desktop/Repo/JPEG_conv/quantizator/quantizator.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log quant.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source quant.tcl
