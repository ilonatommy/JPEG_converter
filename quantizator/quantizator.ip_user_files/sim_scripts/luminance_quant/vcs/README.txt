...
#
# Generated by export_simulation on Fri Aug 02 09:32:25 +0200 2019
#
################################################################################
...
switch to the './luminance_quant.sh' script.

./luminance_quant.sh -reset_run
...
./luminance_quant.sh -noclean_files

For more information on the script, please type './luminance_quant.sh -help'.
