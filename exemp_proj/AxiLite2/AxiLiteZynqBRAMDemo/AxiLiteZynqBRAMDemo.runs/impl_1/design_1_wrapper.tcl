...
set rc [catch {
  ...
  set_property webtalk.parent_dir F:/VivadoProjects/AxiLiteZynqBRAMDemo/AxiLiteZynqBRAMDemo/AxiLiteZynqBRAMDemo.cache/wt [current_project]
  set_property parent.project_path F:/VivadoProjects/AxiLiteZynqBRAMDemo/AxiLiteZynqBRAMDemo/AxiLiteZynqBRAMDemo.xpr [current_project]
  set_property ip_repo_paths {
  F:/VivadoProjects/AxiLiteZynqBRAMDemo/ip_repo/AXILiteToBRAMIntf_1.0
  F:/VivadoProjects/AxiLiteZynqBRAMDemo/ip_repo/BRAMContrl_1.0
} [current_project]
  set_property ip_output_repo F:/VivadoProjects/AxiLiteZynqBRAMDemo/AxiLiteZynqBRAMDemo/AxiLiteZynqBRAMDemo.cache/ip [current_project]
  set_property ip_cache_permissions {read write} [current_project]
  set_property XPM_LIBRARIES {XPM_CDC XPM_MEMORY} [current_project]
  add_files -quiet F:/VivadoProjects/AxiLiteZynqBRAMDemo/AxiLiteZynqBRAMDemo/AxiLiteZynqBRAMDemo.runs/synth_1/design_1_wrapper.dcp
  set_msg_config -source 4 -id {BD 41-1661} -suppress
  set_param project.isImplRun true
  add_files F:/VivadoProjects/AxiLiteZynqBRAMDemo/AxiLiteZynqBRAMDemo/AxiLiteZynqBRAMDemo.srcs/sources_1/bd/design_1/design_1.bd
  set_property is_locked true [get_files F:/VivadoProjects/AxiLiteZynqBRAMDemo/AxiLiteZynqBRAMDemo/AxiLiteZynqBRAMDemo.srcs/sources_1/bd/design_1/design_1.bd]
  set_param project.isImplRun false
  read_xdc F:/VivadoProjects/AxiLiteZynqBRAMDemo/ZYBO_Master.xdc
  set_param project.isImplRun true
