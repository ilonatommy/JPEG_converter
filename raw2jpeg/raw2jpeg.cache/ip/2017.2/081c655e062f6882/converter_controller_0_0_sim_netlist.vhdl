...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_controller is
  ...
  signal \ce_zz_trigger[6]_i_2_n_0\ : STD_LOGIC;
  signal \ce_zz_trigger_reg__0\ : STD_LOGIC_VECTOR ( 6 downto 0 );
  ...
  attribute SOFT_HLUTNM of \_ce_zig_zag_i_2\ : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of \_rst_i_1\ : label is "soft_lutpair6";
  attribute SOFT_HLUTNM of \addr_in[1]_i_1\ : label is "soft_lutpair9";
  attribute SOFT_HLUTNM of \addr_in[2]_i_1\ : label is "soft_lutpair9";
  attribute SOFT_HLUTNM of \addr_in[3]_i_1\ : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of \addr_in[4]_i_1\ : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of \addr_qu[0]_i_1\ : label is "soft_lutpair10";
  attribute SOFT_HLUTNM of \addr_qu[1]_i_1\ : label is "soft_lutpair10";
  attribute SOFT_HLUTNM of \addr_qu[2]_i_1\ : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of \addr_qu[3]_i_1\ : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of \ce_trigger[0]_i_1\ : label is "soft_lutpair8";
  attribute SOFT_HLUTNM of \ce_trigger[1]_i_1\ : label is "soft_lutpair8";
  attribute SOFT_HLUTNM of \ce_trigger[2]_i_1\ : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of \ce_zz_trigger[0]_i_1\ : label is "soft_lutpair11";
  attribute SOFT_HLUTNM of \ce_zz_trigger[1]_i_1\ : label is "soft_lutpair11";
  attribute SOFT_HLUTNM of \ce_zz_trigger[2]_i_1\ : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of \ce_zz_trigger[3]_i_1\ : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of \ce_zz_trigger[4]_i_1\ : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of \ce_zz_trigger[6]_i_1\ : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of \ce_zz_trigger[6]_i_2\ : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of \rst_trigger[0]_i_1\ : label is "soft_lutpair7";
  attribute SOFT_HLUTNM of \rst_trigger[1]_i_1\ : label is "soft_lutpair7";
  attribute SOFT_HLUTNM of \rst_trigger[2]_i_1\ : label is "soft_lutpair6";
begin
...
\ce_zz_trigger[0]_i_1\: unisim.vcomponents.LUT1
    generic map(
      INIT => X"1"
    )
        port map (
...
\ce_zz_trigger[1]_i_1\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"6"
    )
        port map (
...
\ce_zz_trigger[2]_i_1\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"78"
    )
        port map (
...
\ce_zz_trigger[3]_i_1\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"7F80"
    )
        port map (
...
\ce_zz_trigger[4]_i_1\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"7FFF8000"
    )
        port map (
...
\ce_zz_trigger[5]_i_1\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"7FFFFFFF80000000"
    )
        port map (
...
\ce_zz_trigger[6]_i_1\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"78"
    )
        port map (
...
\ce_zz_trigger[6]_i_2\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"80000000"
    )
        port map (
...
\ce_zz_trigger_reg[0]\: unisim.vcomponents.FDRE
    generic map(
      INIT => '0'
    )
        port map (
...
\ce_zz_trigger_reg[1]\: unisim.vcomponents.FDRE
    generic map(
      INIT => '0'
    )
        port map (
...
\ce_zz_trigger_reg[2]\: unisim.vcomponents.FDRE
    generic map(
      INIT => '0'
    )
        port map (
...
\ce_zz_trigger_reg[3]\: unisim.vcomponents.FDRE
    generic map(
      INIT => '0'
    )
        port map (
...
\ce_zz_trigger_reg[4]\: unisim.vcomponents.FDRE
    generic map(
      INIT => '0'
    )
        port map (
...
\ce_zz_trigger_reg[5]\: unisim.vcomponents.FDRE
    generic map(
      INIT => '0'
    )
        port map (
...
\ce_zz_trigger_reg[6]\: unisim.vcomponents.FDRE
    generic map(
      INIT => '0'
    )
        port map (
