...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_controller is
  ...
  signal \addr_in[1]_i_2_n_0\ : STD_LOGIC;
  signal \addr_in[2]_i_2_n_0\ : STD_LOGIC;
  signal \addr_in[3]_i_2_n_0\ : STD_LOGIC;
  ...
  signal \addr_qu[2]_i_2_n_0\ : STD_LOGIC;
  signal \addr_qu[3]_i_2_n_0\ : STD_LOGIC;
  signal \addr_qu[4]_i_2_n_0\ : STD_LOGIC;
  signal \addr_qu[5]_i_2_n_0\ : STD_LOGIC;
  signal \^addr_quant\ : STD_LOGIC_VECTOR ( 5 downto 0 );
  signal \^ce\ : STD_LOGIC;
  signal cyclic_reset_trigger : STD_LOGIC_VECTOR ( 7 downto 0 );
  signal \cyclic_reset_trigger[6]_i_2_n_0\ : STD_LOGIC;
  signal \cyclic_reset_trigger[7]_i_2_n_0\ : STD_LOGIC;
  signal \cyclic_reset_trigger[7]_i_3_n_0\ : STD_LOGIC;
  signal \cyclic_reset_trigger[7]_i_4_n_0\ : STD_LOGIC;
  signal cyclic_reset_trigger_0 : STD_LOGIC_VECTOR ( 7 downto 0 );
  signal \^rst\ : STD_LOGIC;
  signal rst_trigger : STD_LOGIC;
  attribute SOFT_HLUTNM : string;
  attribute SOFT_HLUTNM of \_ce_i_2\ : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of \_rst_i_1\ : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of \addr_in[1]_i_2\ : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of \addr_in[2]_i_2\ : label is "soft_lutpair7";
  attribute SOFT_HLUTNM of \addr_in[3]_i_2\ : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of \addr_in[4]_i_2\ : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of \addr_qu[2]_i_2\ : label is "soft_lutpair7";
  attribute SOFT_HLUTNM of \addr_qu[3]_i_2\ : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of \addr_qu[4]_i_2\ : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of \cyclic_reset_trigger[0]_i_1\ : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of \cyclic_reset_trigger[1]_i_1\ : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of \cyclic_reset_trigger[2]_i_1\ : label is "soft_lutpair6";
  attribute SOFT_HLUTNM of \cyclic_reset_trigger[3]_i_1\ : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of \cyclic_reset_trigger[6]_i_1\ : label is "soft_lutpair8";
  attribute SOFT_HLUTNM of \cyclic_reset_trigger[6]_i_2\ : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of \cyclic_reset_trigger[7]_i_2\ : label is "soft_lutpair6";
  attribute SOFT_HLUTNM of \cyclic_reset_trigger[7]_i_3\ : label is "soft_lutpair8";
  attribute SOFT_HLUTNM of \cyclic_reset_trigger[7]_i_4\ : label is "soft_lutpair3";
begin
  addr_input(5 downto 0) <= \^addr_input\(5 downto 0);
  addr_quant(5 downto 0) <= \^addr_quant\(5 downto 0);
  ce <= \^ce\;
  rst <= \^rst\;
\_ce_i_1\: unisim.vcomponents.LUT6
    generic map(
...
\_ce_i_2\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"FFFEFFFF"
    )
        port map (
...
\_rst_i_1\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"555555D5"
    )
        port map (
...
\addr_in[0]_i_1\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"0000FFF7FFF70000"
    )
        port map (
...
\addr_in[1]_i_1\: unisim.vcomponents.LUT6
    generic map(
...
\addr_in[1]_i_2\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"7"
    )
        port map (
...
\addr_in[2]_i_1\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"FFF700000000FFF7"
    )
        port map (
      I0 => cyclic_reset_trigger(1),
      I1 => cyclic_reset_trigger(4),
...
\addr_in[2]_i_2\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"7F"
    )
        port map (
...
\addr_in[3]_i_2\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"7FFF"
    )
        port map (
...
\addr_in[4]_i_1\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"FFF700000000FFF7"
    )
        port map (
...
\addr_in[4]_i_2\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"7FFFFFFF"
    )
        port map (
...
\addr_in[5]_i_1\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"EFFF0000"
    )
        port map (
...
\addr_in[5]_i_2\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"A8AAAAAA54555555"
    )
        port map (
...
\addr_in[5]_i_3\: unisim.vcomponents.LUT6
    generic map(
...
\addr_qu[0]_i_1\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"0000FFF7FFF70000"
    )
        port map (
...
\addr_qu[1]_i_1\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"00FEFEFEFE000000"
    )
        port map (
...
\addr_qu[2]_i_1\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"FFF700000000FFF7"
    )
        port map (
...
\addr_qu[2]_i_2\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"7F"
    )
        port map (
...
\addr_qu[3]_i_2\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"7FFF"
    )
        port map (
...
\addr_qu[4]_i_1\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"FFF700000000FFF7"
    )
        port map (
...
\addr_qu[4]_i_2\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"7FFFFFFF"
    )
        port map (
...
\addr_qu[5]_i_2\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"7FFFFFFFFFFFFFFF"
    )
        port map (
...
\cyclic_reset_trigger[0]_i_1\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"00F7"
    )
        port map (
...
\cyclic_reset_trigger[1]_i_1\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"0FB0"
    )
        port map (
...
\cyclic_reset_trigger[4]_i_1\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"62CCC8CCC8CCC8CC"
    )
        port map (
      I0 => cyclic_reset_trigger(0),
      I1 => cyclic_reset_trigger(4),
...
\cyclic_reset_trigger[6]_i_1\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"D2"
    )
        port map (
...
\cyclic_reset_trigger[6]_i_2\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"7FFFFFFF"
    )
        port map (
...
\cyclic_reset_trigger[7]_i_1\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"CCCCCCCCCCC68882"
    )
        port map (
      I0 => cyclic_reset_trigger(0),
...
\cyclic_reset_trigger[7]_i_2\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"7"
    )
        port map (
...
\cyclic_reset_trigger[7]_i_3\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"7"
    )
        port map (
...
\cyclic_reset_trigger[7]_i_4\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FFFE"
    )
        port map (
...
\cyclic_reset_trigger_reg[6]\: unisim.vcomponents.FDRE
    generic map(
      INIT => '0'
    )
        port map (
...
\cyclic_reset_trigger_reg[7]\: unisim.vcomponents.FDRE
    generic map(
      INIT => '0'
    )
        port map (
