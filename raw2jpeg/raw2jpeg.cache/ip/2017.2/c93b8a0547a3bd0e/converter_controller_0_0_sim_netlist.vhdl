...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_controller is
  ...
  signal rst_trigger : STD_LOGIC_VECTOR ( 1 downto 0 );
  signal \rst_trigger[0]_i_1_n_0\ : STD_LOGIC;
  signal \rst_trigger[1]_i_1_n_0\ : STD_LOGIC;
  attribute SOFT_HLUTNM : string;
  attribute SOFT_HLUTNM of \_rst_i_1\ : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of \addr_in[1]_i_1\ : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of \addr_in[2]_i_1\ : label is "soft_lutpair2";
  ...
  attribute SOFT_HLUTNM of \addr_qu[0]_i_1\ : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of \addr_qu[1]_i_1\ : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of \addr_qu[2]_i_1\ : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of \addr_qu[3]_i_1\ : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of \rst_trigger[1]_i_1\ : label is "soft_lutpair3";
begin
  addr_input(5 downto 0) <= \^addr_input\(5 downto 0);
  addr_quant(5 downto 0) <= \^addr_quant\(5 downto 0);
  rst <= \^rst\;
\_rst_i_1\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"8E"
    )
        port map (
...
\rst_trigger[0]_i_1\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"1"
    )
        port map (
