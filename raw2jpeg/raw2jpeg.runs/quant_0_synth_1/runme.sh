...
HD_PWD='C:/Users/lsneler/Desktop/Repository/JPEG_conversion/raw2jpeg/raw2jpeg.runs/quant_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log quant_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source quant_0.tcl
