...
HD_PWD='C:/Users/lsneler/Desktop/Repository/JPEG_conversion/raw2jpeg/raw2jpeg.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log converter_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source converter_wrapper.tcl
