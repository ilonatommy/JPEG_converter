...
HD_PWD='C:/Users/lsneler/Desktop/Repo/JPEG_conv/raw2jpeg.runs/val_holder_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log val_holder_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source val_holder_0.tcl
