...
HD_PWD='C:/Users/lsneler/Desktop/Repository/JPEG_conversion/raw2jpeg/raw2jpeg.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log converter_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source converter_wrapper.tcl -notrace
