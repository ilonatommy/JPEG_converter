...
set rc [catch {
  ...
  set_param project.isImplRun false
  write_hwdef -force -file converter_wrapper.hwdef
...
set rc [catch {
  ...
  opt_design 
  write_checkpoint -force converter_wrapper_opt.dcp
  catch { report_drc -file converter_wrapper_drc_opted.rpt }
...
set rc [catch {
  ...
  place_design 
  write_checkpoint -force converter_wrapper_placed.dcp
  catch { report_io -file converter_wrapper_io_placed.rpt }
  catch { report_utilization -file converter_wrapper_utilization_placed.rpt -pb converter_wrapper_utilization_placed.pb }
  catch { report_control_sets -verbose -file converter_wrapper_control_sets_placed.rpt }
...
set rc [catch {
  ...
  route_design 
  write_checkpoint -force converter_wrapper_routed.dcp
  catch { report_drc -file converter_wrapper_drc_routed.rpt -pb converter_wrapper_drc_routed.pb -rpx converter_wrapper_drc_routed.rpx }
  catch { report_methodology -file converter_wrapper_methodology_drc_routed.rpt -rpx converter_wrapper_methodology_drc_routed.rpx }
  catch { report_power -file converter_wrapper_power_routed.rpt -pb converter_wrapper_power_summary_routed.pb -rpx converter_wrapper_power_routed.rpx }
  catch { report_route_status -file converter_wrapper_route_status.rpt -pb converter_wrapper_route_status.pb }
  catch { report_clock_utilization -file converter_wrapper_clock_utilization_routed.rpt }
  catch { report_timing_summary -warn_on_violation -max_paths 10 -file converter_wrapper_timing_summary_routed.rpt -rpx converter_wrapper_timing_summary_routed.rpx }
  close_msg_db -file route_design.pb
} RESULT]
if {$rc} {
  write_checkpoint -force converter_wrapper_routed_error.dcp
