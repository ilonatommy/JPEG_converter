...
HD_PWD='C:/Users/lsneler/Desktop/Repo/JPEG_conv/raw2jpeg/raw2jpeg.runs/converter_val_holder_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log converter_val_holder_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source converter_val_holder_0_1.tcl
