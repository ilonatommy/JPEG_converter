...
set_property IOSTANDARD LVCMOS33 [get_ports {num_0s[0]}]

##IO_L21P_T3_DQS_AD14P_35
set_property PACKAGE_PIN N15 [get_ports {num_0s[1]}]
set_property IOSTANDARD LVCMOS33 [get_ports {num_0s[1]}]

##IO_L22N_T3_AD7N_35
set_property PACKAGE_PIN L15 [get_ports {num_0s[2]}]
set_property IOSTANDARD LVCMOS33 [get_ports {num_0s[2]}]

##IO_L22P_T3_AD7P_35
set_property PACKAGE_PIN L14 [get_ports {num_0s[3]}]
set_property IOSTANDARD LVCMOS33 [get_ports {num_0s[3]}]
...
##IO_L20N_T3_AD6N_35
#set_property PACKAGE_PIN J14 [get_ports {pixel_out[6]}]
#set_property IOSTANDARD LVCMOS33 [get_ports {pixel_out[6]}]

##IO_L20P_T3_AD6P_35
#set_property PACKAGE_PIN K14 [get_ports {pixel_out[7]}]
#set_property IOSTANDARD LVCMOS33 [get_ports {pixel_out[7]}]

##Pmod Header JB
##IO_L15N_T2_DQS_34
set_property PACKAGE_PIN U20 [get_ports {next_value[0]}]
set_property IOSTANDARD LVCMOS33 [get_ports {next_value[0]}]

##IO_L15P_T2_DQS_34
set_property PACKAGE_PIN T20 [get_ports {next_value[1]}]
set_property IOSTANDARD LVCMOS33 [get_ports {next_value[1]}]

##IO_L16N_T2_34
set_property PACKAGE_PIN W20 [get_ports {next_value[2]}]
set_property IOSTANDARD LVCMOS33 [get_ports {next_value[2]}]

##IO_L16P_T2_34
set_property PACKAGE_PIN V20 [get_ports {next_value[3]}]
set_property IOSTANDARD LVCMOS33 [get_ports {next_value[3]}]

##IO_L17N_T2_34
set_property PACKAGE_PIN Y19 [get_ports {next_value[4]}]
set_property IOSTANDARD LVCMOS33 [get_ports {next_value[4]}]

##IO_L17P_T2_34
set_property PACKAGE_PIN Y18 [get_ports {next_value[5]}]
set_property IOSTANDARD LVCMOS33 [get_ports {next_value[5]}]

##IO_L22N_T3_34
set_property PACKAGE_PIN W19 [get_ports {next_value[6]}]
set_property IOSTANDARD LVCMOS33 [get_ports {next_value[6]}]

##IO_L22P_T3_34
set_property PACKAGE_PIN W18 [get_ports {next_value[7]}]
set_property IOSTANDARD LVCMOS33 [get_ports {next_value[7]}]

##Pmod Header JC
##IO_L10N_T1_34
#set_property PACKAGE_PIN W15 [get_ports {ce_zig_zag}]
#set_property IOSTANDARD LVCMOS33 [get_ports {ce_zig_zag}]

##IO_L10P_T1_34
#set_property PACKAGE_PIN V15 [get_ports {we_zzBRAM_in}]
#set_property IOSTANDARD LVCMOS33 [get_ports {we_zzBRAM_in}]

##IO_L1N_T0_34
#set_property PACKAGE_PIN T10 [get_ports {we_zzBRAM_out}]
#set_property IOSTANDARD LVCMOS33 [get_ports {we_zzBRAM_out}]

##IO_L1P_T0_34
#set_property PACKAGE_PIN T11 [get_ports {v_sync}]
#set_property IOSTANDARD LVCMOS33 [get_ports {v_sync}]
