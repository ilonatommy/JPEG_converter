...
module design_1
  ...
  wire [7:0]controller_0_addr_zzBRAM_in;
  ...
  wire controller_0_we_zzBRAM_out;
  wire [7:0]quant_0_pixel_out;
  wire reset_rtl_1;
  wire sys_clock_1;
  wire [7:0]zig_zag_0_addr_BRAM_in;
  ...
  assign v_sync = controller_0_v_sync;
  ...
  design_1_blk_mem_gen_1_0 blk_mem_gen_1
       (.addra(zig_zag_0_addr_BRAM_in),
        .addrb(controller_0_addr_zzBRAM_in),
        .clka(clk_wiz_0_clk_out1),
        .clkb(clk_wiz_0_clk_out1),
        .dina(quant_0_pixel_out),
        .doutb(blk_mem_gen_1_doutb),
        .ena(controller_0_we_zzBRAM_in),
        .enb(controller_0_we_zzBRAM_out),
  ...
  design_1_controller_0_0 controller_0
       (.addr_input(controller_0_addr_input),
        ...
        .addr_zzBRAM_in(controller_0_addr_zzBRAM_in),
        ...
        .we_zzBRAM_out(controller_0_we_zzBRAM_out));
  ...
  design_1_zig_zag_0_0 zig_zag_0
       (.addr_BRAM_in(zig_zag_0_addr_BRAM_in),
