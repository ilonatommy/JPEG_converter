...
-- Command     : write_vhdl -force -mode funcsim -rename_top converter_controller_0_0 -prefix
--               converter_controller_0_0_ converter_controller_0_0_sim_netlist.vhdl
...
architecture STRUCTURE of converter_controller_0_0_controller is
  ...
  attribute SOFT_HLUTNM of \_ce_BRAM_write_i_2\ : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of \_ce_i_1\ : label is "soft_lutpair7";
  attribute SOFT_HLUTNM of \_ce_zig_zag_i_1\ : label is "soft_lutpair10";
  attribute SOFT_HLUTNM of \_rst_i_1\ : label is "soft_lutpair6";
  attribute SOFT_HLUTNM of \addr_BRAM_wr[1]_i_1\ : label is "soft_lutpair9";
  attribute SOFT_HLUTNM of \addr_BRAM_wr[2]_i_1\ : label is "soft_lutpair9";
  attribute SOFT_HLUTNM of \addr_BRAM_wr[3]_i_1\ : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of \addr_BRAM_wr[4]_i_1\ : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of \addr_BRAM_wr[6]_i_1\ : label is "soft_lutpair13";
  attribute SOFT_HLUTNM of \addr_BRAM_wr[7]_i_3\ : label is "soft_lutpair13";
  attribute SOFT_HLUTNM of \addr_in[1]_i_1\ : label is "soft_lutpair12";
  attribute SOFT_HLUTNM of \addr_in[2]_i_1\ : label is "soft_lutpair12";
  attribute SOFT_HLUTNM of \addr_in[3]_i_1\ : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of \addr_in[4]_i_1\ : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of \addr_qu[0]_i_1\ : label is "soft_lutpair17";
  attribute SOFT_HLUTNM of \addr_qu[1]_i_1\ : label is "soft_lutpair17";
  attribute SOFT_HLUTNM of \addr_qu[2]_i_1\ : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of \addr_qu[3]_i_1\ : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of \ce_trigger[0]_i_1\ : label is "soft_lutpair11";
  attribute SOFT_HLUTNM of \ce_trigger[1]_i_1\ : label is "soft_lutpair11";
  attribute SOFT_HLUTNM of \ce_trigger[2]_i_1\ : label is "soft_lutpair7";
  attribute SOFT_HLUTNM of \ce_zz_bram_trigger[0]_i_1\ : label is "soft_lutpair16";
  attribute SOFT_HLUTNM of \ce_zz_bram_trigger[1]_i_1\ : label is "soft_lutpair16";
  attribute SOFT_HLUTNM of \ce_zz_bram_trigger[2]_i_1\ : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of \ce_zz_bram_trigger[3]_i_1\ : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of \ce_zz_bram_trigger[4]_i_1\ : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of \ce_zz_bram_trigger[6]_i_2\ : label is "soft_lutpair10";
  ...
  attribute SOFT_HLUTNM of \rst_trigger[0]_i_1\ : label is "soft_lutpair8";
  attribute SOFT_HLUTNM of \rst_trigger[1]_i_1\ : label is "soft_lutpair8";
