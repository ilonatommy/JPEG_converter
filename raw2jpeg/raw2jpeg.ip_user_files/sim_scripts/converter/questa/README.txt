...
#
# Generated by export_simulation on Tue Aug 20 13:14:53 +0200 2019
#
################################################################################
...
switch to the './converter.sh' script.

./converter.sh -reset_run
...
./converter.sh -noclean_files

For more information on the script, please type './converter.sh -help'.
