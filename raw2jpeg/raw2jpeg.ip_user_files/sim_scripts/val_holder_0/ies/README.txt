...
#
# Generated by export_simulation on Wed Aug 21 12:22:06 +0200 2019
#
################################################################################
...
switch to the './val_holder_0.sh' script.

./val_holder_0.sh -reset_run
...
./val_holder_0.sh -noclean_files

For more information on the script, please type './val_holder_0.sh -help'.
