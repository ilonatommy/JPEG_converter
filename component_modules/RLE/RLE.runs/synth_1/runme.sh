...
HD_PWD='C:/Users/lsneler/Desktop/Repo/JPEG_conv/component_modules/RLE/RLE.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log RLE.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source RLE.tcl
