...
HD_PWD='C:/Users/lsneler/Desktop/Repo/JPEG_conv/component_modules/RLE/RLE.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log RLE.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source RLE.tcl -notrace
