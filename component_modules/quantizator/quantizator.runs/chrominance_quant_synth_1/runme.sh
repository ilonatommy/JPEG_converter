...
HD_PWD='C:/Users/lsneler/Desktop/Repository/JPEG_conversion/quantizator/quantizator.runs/chrominance_quant_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log chrominance_quant.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source chrominance_quant.tcl
