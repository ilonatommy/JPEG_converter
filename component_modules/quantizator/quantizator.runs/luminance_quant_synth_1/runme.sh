...
HD_PWD='C:/Users/lsneler/Desktop/Repository/JPEG_conversion/quantizator/quantizator.runs/luminance_quant_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log luminance_quant.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source luminance_quant.tcl
