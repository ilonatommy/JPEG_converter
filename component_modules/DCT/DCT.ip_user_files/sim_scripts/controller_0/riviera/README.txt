...
#
# Generated by export_simulation on Fri Aug 23 11:00:54 +0200 2019
#
################################################################################
...
switch to the './controller_0.sh' script.

./controller_0.sh -reset_run
...
./controller_0.sh -noclean_files

For more information on the script, please type './controller_0.sh -help'.
