...
HD_PWD='C:/Users/lsneler/Desktop/Repo/JPEG_conv/component_modules/DPCM/DPCM.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log DPCM.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source DPCM.tcl
